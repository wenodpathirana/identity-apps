 ...
 */
type SMSOTPQuickStartPropsInterface = TestableComponentInterface;

/**
 * Quick start content for the SMS OTP authenticator.
 *
 * @param {SMSOTPQuickStartPropsInterface} props - Props injected into the component.
 *
        ...
        },
        {
            stepContent: (
                <>
                    <Text>
                        <Trans
                            i18nKey={ "extensions:develop.identityProviders.smsOTP.quickStart.steps.selectSMSOTP.content" }
                        >
...
SMSOTPQuickStart.defaultProps = {
    "data-testid": "sms-otp-authenticator-quick-start"
};
